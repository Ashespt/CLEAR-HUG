...
do
    ...
    do
        rm -r checkpoints/finetune_ours_test_0.1/ptbxl/sub/finetune_subdiagnostic_base_linear_${ratio}_${method}
        ...
        torchrun --nnodes=1 --master_port=$PORT --nproc_per_node=1 run_class_finetuning.py \
            ...
            --output_dir checkpoints/finetune_ours_test_0.1/ptbxl/sub/finetune_subdiagnostic_base_linear_${ratio}_${method}/ \
            --log_dir log/finetune_ours_test_0.1/sub/finetune_subdiagnostic_base_linear_${ratio}_${method} \
