...
# Train
# 
rm -r checkpoints/finetune_ours_test_1.0/ptbxl/sub/
...
do
    ...
    do
        ...
        torchrun --nnodes=1 --master_port=$PORT --nproc_per_node=1 run_class_finetuning.py \
            ...
            --output_dir checkpoints/finetune_ours_test_1.0/ptbxl/sub/finetune_subdiagnostic_base_linear_${ratio}_${method}/ \
            --log_dir log/finetune_ours_test_1.0/sub/finetune_subdiagnostic_base_linear_${ratio}_${method} \
