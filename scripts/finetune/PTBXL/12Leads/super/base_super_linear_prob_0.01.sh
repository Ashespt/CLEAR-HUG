...
# Train
rm -r checkpoints/finetune_ours_test_0.01/ptbxl/super/
...
do
    ...
    do
        ...
        torchrun --nnodes=1 --master_port=$PORT --nproc_per_node=1 run_class_finetuning.py \
            ...
            --output_dir checkpoints/finetune_ours_test_0.01/ptbxl/super/finetune_superdiagnostic_base_linear_${ratio}_${method}/ \
            --log_dir log/finetune_ours_test_0.01/ptbxl/super/finetune_superdiagnostic_base_linear_${ratio}_${method} \
