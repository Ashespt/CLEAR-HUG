...
if __name__ == "__main__":
    ...
    dataset_path = "./datasets/dataset_preprocess/CPSC2018"
    for data_type in data_types:

        file_path = os.path.join(dataset_path, f"icbeb_{data_type}.csv")
        ...
        for idx, row in tqdm(
            ...
            data_path = os.path.join(dataset_path, 'wfdb', row["filename"] + ".mat")
            # import pdb;pdb.set_trace()
            # ecg_data = loadmat(data_path)['ECG'][0]][0][0][2]
            ecg_data = loadmat(data_path)[[*loadmat(data_path)][0]]
