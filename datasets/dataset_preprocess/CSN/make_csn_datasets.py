...
if __name__ == "__main__":
    ...
    dataset_path = "datasets/dataset_preprocess/CSN"
    for data_type in data_types:

        file_path = os.path.join(dataset_path, f"chapman_{data_type}.csv")
        ...
        for idx, row in tqdm(
            ...
            ecg_data = loadmat(os.path.join(dataset_path,data_path))["val"].astype(np.float32)
