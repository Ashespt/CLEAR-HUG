...
class SCP_Experiment:
    ...
    def prepare(self):
        ...
        np.save(
            self.outputfolder + self.experiment_name + "/data/train_data.npy",
            self.X_train,
        )
        np.save(
        ...
        np.save(
            self.outputfolder + self.experiment_name + "/data/train_labels.npy",
            self.y_train,
        )
        np.save(
            self.outputfolder + self.experiment_name + "/data/val_labels.npy",
            self.y_val,
        )
        np.save(
